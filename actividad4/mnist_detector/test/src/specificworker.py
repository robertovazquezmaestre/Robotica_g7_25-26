...
class SpecificWorker(GenericWorker):
    ...
    def startup_check(self):
        print(f"Testing RoboCompMNIST.TData from ifaces.RoboCompMNIST")
        test = ifaces.RoboCompMNIST.TData()
    ...
    ######################
    # From the RoboCompMNIST you can call this methods:
    # RoboCompMNIST.TData self.mnist_proxy.getNumber()

    ######################
    # From the RoboCompMNIST you can use this types:
    # ifaces.RoboCompMNIST.TData
