...
class Requires:
    def __init__(self, ice_connector:Ice.CommunicatorI, parameters):
        ...
        self.MNIST = self.create_proxy("MNIST", RoboCompMNIST.MNISTPrx, parameters["Proxies"]["MNIST"])
...
class Implements:
    def __init__(self, ice_connector:Ice.CommunicatorI, default_handler, parameters):
        ...
        self.camera360rgb = self.create_adapter("Camera360RGB", camera360rgbI.Camera360RGBI(default_handler, ""), parameters["Endpoints"]["Camera360RGB"])
